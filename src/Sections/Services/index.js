  ...
  return (
    <ServiceSection id="services">
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Fontend Design"
          title={<h1>Frontend Development</h1>}
          subText={
            <h5>
              I can Desgin UI with your own choice.
            </h5>
          }
        />
        <OBJ>
      ...
      <Content ref={addToRefs}>
        <TextBlock
          ...
          subText={
            <h5>
             I can develop your own website with different functionalities.
            </h5>
          }
        />
        <OBJ>
      ...
      <Content>
        <TextBlock
          topic="Backend"
          title={<h1>Backend Development</h1>}
          subText={
            <h5>
             I can also work with backend languages like Node.js, Express.js
            </h5>
          }
        />
        <OBJ>
